module memoriaInstrucoes #(parameter memSize = 8) (
    ...
    initial begin
        ...
        memory[1] = 32'b00100010001010000000000000001010; // addi $8, $17, 10
        memory[2] = 32'b00000010001100100100000000100010; // sub $8, $17, $18
        memory[3] = 32'b00000001000100010100100000100100; // and $9, $8, $17
		  memory[4] = 32'b00000001000100100101000000100101; // or $10, $8, $18
		  memory[5] = 32'b00000010001100100100100000101010; // slt $9, $17, $18
